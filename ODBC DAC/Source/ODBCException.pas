...
const
  MAXBUFLEN = 256;
var
  ErrorMsg, SQLState: array[0..MAXBUFLEN - 1] of SQLCHAR;
  ...
  case ARetCode of
    SQL_ERROR, SQL_SUCCESS_WITH_INFO:
      begin
        ...
        while SQLGetDiagRec(AHandleType, AHandle, RecNum, @SQLState, @NativeError, @ErrorMsg, MAXBUFLEN, nil) <> SQL_NO_DATA do
        begin
