...
begin
  ...
  // prepare SQL
{$IFNDEF USE_UNICODE_DRIVER}
  CheckError(SQLSetStmtAttrA(FStmtHandle, SQL_ATTR_CURSOR_TYPE, SQLPOINTER(SQL_CURSOR_STATIC), SQL_IS_UINTEGER));
  CheckError(SQLPrepareA(FStmtHandle, PSQLCHAR(AnsiString(FProcessedSQL)), SQL_NTS));
{$ELSE}
  CheckError(SQLSetStmtAttrW(FStmtHandle, SQL_ATTR_CURSOR_TYPE, SQLPOINTER(SQL_CURSOR_STATIC), SQL_IS_UINTEGER));
