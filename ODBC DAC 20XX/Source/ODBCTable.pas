...
type
  ...
  protected
    ...
    procedure DataEvent(Event: TDataEvent; Info: {$IFDEF RTLVersion >= 16.0}NativeInt{$ELSE}Longint{$ENDIF}); override;
...
procedure TODBCTable.DataEvent(Event: TDataEvent; Info: {$IFDEF RTLVersion >= 16.0}NativeInt{$ELSE}Longint{$ENDIF});
begin
