...
{$IFDEF PostgreSQL}
  CR_TABLE = 'CREATE TABLE blob_test (c1 integer PRIMARY KEY, c2 float, c3 char(5), c4 text, c5 bytea)';
{$ENDIF}
...
begin
  ...
  begin
    ...
    ODBCQuery.Params.ParamByName('p3').AsAnsiString := 'test' + AnsiString(IntToStr(i));
