...
begin
  ...
  with PRecInfo(TRecordBuffer(Buffer) + SizeOf(TKeyBuffer))^ do
  begin
...
begin
  ...
  begin
    ...
    Buff := TRecordBuffer(FKeyBuffer) + SizeOf(TKeyBuffer);
...
function TODBCTable.GetFieldData(Field: TField; Buffer: TValueBuffer): Boolean;
var
...
begin
  ...
  begin
    ...
    begin
      Data := Buff + MetaFields^[Field.FieldNo].DataOfs;
